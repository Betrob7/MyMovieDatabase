...
function searchListener() {
  document
    ...
    .addEventListener("submit", function (event) {
      // lyssnar på submit på formuläret
      ...
      let userInput = document
        ...
        .value.toLowerCase(); //sparar ner användarens sökning
...
function moreInfoListener() {
  ...
  for (let movie of movies) {
    //loopar igenom arrayen och lägger till lyssnare på varje enskild film
    movie.addEventListener("click", (event) => {
      ...
      if (!imdbID) {
        //felhantering, om inget imdbID hittas så loggas ett felmeddelande och sen avslutas funktionen
...
function likeButtonListener() {
  ...
  likeButtons.forEach((button) => {
    //loopar igenom och lägger till en lyssnare på like-knappen på varje enskild kort
...
function backButtonListener() {
  ...
  backBtn.addEventListener("click", () => {
    //vid klick på knappen tas användaren tillbaka till föregående sida
    window.history.back();
  });
}
...
function dropdownMenuListener() {
  ...
  searchInput.addEventListener("input", async function () {
    //lyssnar efter input på sökfältet
  ...
  document.addEventListener("click", (event) => {
    //lyssnar efter klick var som helst på sidan
    if (!event.target.closest(".header__form")) {
      //om klicket sker utanför sökformuläret
...
function dropdownMenuMovieListener(movieList) {
  ...
  movieList.addEventListener("click", () => {
    //sätter lyssnaren på list-elementet(varje li-element innehåller en filmtitel)
